...
public class Sales {
    ...
    private Double complimentarySale;
    ...
    protected void calculateTotal() {
        ...
        double complimentary = complimentarySale != null ? complimentarySale : 0.0;
        this.totalSale = cash + upi + card + swiggy + zomato + other - complimentary;
    }
}
